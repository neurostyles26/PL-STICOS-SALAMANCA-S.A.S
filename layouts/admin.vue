<template>
  <div class="min-h-screen bg-slate-100 flex flex-col md:flex-row">
    ...
    <aside class="hidden md:flex flex-col w-72 bg-brand-dark-950 text-slate-300 border-r border-brand-dark-900 shrink-0 select-none">
    ...
    <header class="md:hidden w-full bg-brand-dark-950 text-white p-4 flex justify-between items-center shadow-md">
      <Logo size="sm" />
      <button 
    ...
    >
      <div 
        ...
        class="absolute top-16 left-0 right-0 bg-brand-dark-950 text-slate-300 p-6 flex flex-col gap-6 md:hidden z-40 border-t border-brand-dark-900 shadow-2xl"
      >
